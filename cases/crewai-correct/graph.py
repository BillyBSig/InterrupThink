"""One CrewAI role. Think loop = run_session. Not kickoff, not two specialists."""
...
def _role_crew() -> tuple[Agent, Crew]:
    writer = Agent(
        role="Host File Writer",
        goal="Write the sandbox host file from the ticket, after any supervisor correction.",
...
def analyze(out: CorrectOutcome) -> dict:
    ...
    return {
        ...
        "agent_count": len(out.crew.agents),
    }
